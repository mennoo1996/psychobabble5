...
public class TransferLogicTest {
	...
	public void testRequestTransfer() {
		...
		TransferList existingTransfers = new TransferList();
		GameLogic.setSeed(72);
		String expected = "Congratulations! Your bid of 1.0E8 got accepted and Sánchez is now part of your team";
		...
		expected = "Aston Villa did not accept your offer of 3.0E7 for Sánchez. They have indicated they want at least 4.0E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 30000000, library, existingTransfers);
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 5000.0 for Sánchez. They have indicated they want at least 3.15E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 5000, library, new TransferList());
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 3.2E7 for Sánchez. They have indicated they want at least 3.5E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 32000000, library, new TransferList());
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 3.6E7 for Sánchez. They have indicated they want at least 3.675E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 36000000, library, new TransferList());
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 3.7E7 for Sánchez. They have indicated they want at least 3.85E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 37000000, library, new TransferList());
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 3.9E7 for Sánchez. They have indicated they want at least 4.025E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 39000000, library, new TransferList());
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 4.05E7 for Sánchez. They have indicated they want at least 4.2E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 40500000, library, new TransferList());
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 4.3E7 for Sánchez. They have indicated they want at least 4.375E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 43000000, library, new TransferList());
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 4.4E7 for Sánchez. They have indicated they want at least 4.55E7 for this player";
		result = TransferLogic.requestTransfer(player, playersTeam, 44000000, library, new TransferList());
		assertEquals(expected, result);
		expected = "Congratulations! Your bid of 6.0E7 got accepted and Sánchez is now part of your team";
		...
		expected = "Aston Villa did not accept your offer of 2.0E7 for Sánchez. They have indicated they want at least 3.15E7 for this player";
		assertEquals(expected, result);
		expected = "Aston Villa did not accept your offer of 3.2E7 for Sánchez. They have indicated they want at least 3.5E7 for this player";
	...
	public void testRequestSell() {
		...
		expected = "Congratulations! Sánchez got bought by Chelsea for the price of 3.0E7";
		assertEquals(expected, result);
		result = TransferLogic.requestSell(player, playersTeam, 34000000, library);
		expected = "Congratulations! Sánchez got bought by Chelsea for the price of 3.4E7";
		assertEquals(expected, result);
		GameLogic.setSeed(72);
		result = TransferLogic.requestSell(player, playersTeam, 34000000, library);
		...
		expected = "Congratulations! Sánchez got bought by Liverpool for the price of 3.55E7";
		assertEquals(expected, result);
		result = TransferLogic.requestSell(player, playersTeam, 37000000, library);
		expected = "Congratulations! Sánchez got bought by Manchester United for the price of 3.7E7";
		assertEquals(expected, result);
		result = TransferLogic.requestSell(player, playersTeam, 39000000, library);
		expected = "Congratulations! Sánchez got bought by Manchester City for the price of 3.9E7";
		assertEquals(expected, result);
		result = TransferLogic.requestSell(player, playersTeam, 41000000, library);
		expected = "Congratulations! Sánchez got bought by Manchester City for the price of 4.1E7";
		assertEquals(expected, result);
